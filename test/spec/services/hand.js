...
describe('Service: Hand', () => {
  ...
  const nineOfHarts = { value: 8, type: 'H' };
  const fiveOfHarts = { value: 4, type: 'H' };
  const twoOfHarts = { value: 1, type: 'H' };
  ...
  const jackOfFlowers = { value: 10, type: 'F' };
  const sevenOfFlower = { value: 6, type: 'F' };
  const threeOfFlowers = { value: 2, type: 'F' };
  ...
  //     ];
  //
  //     expect(Hand.straightFlush(okCards)).toEqual({ found: true,
  //       points: 45 });
  //
  ...
  //     ];
  //
  //     expect(Hand.royalFlush(okCards)).toEqual({ found: true,
  //       points: 100 });
  //
  ...
  describe('straight', () => {
    it('works', () => {
      ...
      // ];
      //
      // expect(Hand.straight(okCards)).toEqual({ found: true, points: 55 });

      const badCards = [aceOfHarts, kingOfSpades, kingOfHarts,
        queenOfSpades,
        jackOfSpades, jackOfHarts, eigthOfSpades
      ];

      expect(Hand.straight(badCards)).toEqual(notFound);


      // const partialStraightCards = [kingOfDiamonds, jackOfFlowers,
      //   nineOfHarts, sevenOfFlower, fiveOfHarts, threeOfFlowers,
      //   twoOfHarts
      // ];
      //
      // expect(Hand.straight(partialStraightCards)).toEqual(notFound);
    });
  });
  ...
  //     ];
  //
  //     expect(Hand.threeOfAKind(okCards)).toEqual({ found: true,
  //       points: 39 });
  //
  //     const badCards = [aceOfSpades, aceOfHarts, kingOfHarts,
  //       queenOfSpades,
  ...
  //     expect(result.straightFlush).toEqual({ found: true, points: 45 });
